...
const quiz=${data};
var current=0;var answers={};var checked={};var rtStart={};var rtData={};
...
function check(){var q=quiz.questions[current];var id=q.qId||q.number;checked[id]=scoreCurrent();rtData[id]=Math.round((Date.now()-(rtStart[id]||Date.now()))/100)/10;render();}
