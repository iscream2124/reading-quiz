...
function simulateQuiz() {
  ...
  overlay.innerHTML = `<div class="sim-modal"><button class="sim-close" onclick="document.getElementById('simulate-overlay').remove()">✕ Close</button><iframe src="${url}" class="sim-frame"></iframe></div>`;
